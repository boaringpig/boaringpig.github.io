...
/**
 * Shows the spiral generator modal.
 */
window.showSpiralGenerator = function () {
	const modal = document.getElementById("spiralModal");
	if (modal) {
		modal.classList.remove("hidden");
		// Initialize the spiral logic when the modal is shown
		if (window.spiral) {
			window.spiral.init();
...
/**
 * Hides the spiral generator modal.
 */
...
/**
 * Shows the cost tracker modal.
 */
window.showCostTracker = function () {
	const modal = document.getElementById("costTrackerModal");
	if (modal) {
		modal.classList.remove("hidden");
		// Initialize the cost tracker logic when the modal is shown
